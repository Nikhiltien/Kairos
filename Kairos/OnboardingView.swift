...
struct SignInView: View {
    ...
    var body: some View {
        VStack {
            Text("Sign In")
                .font(.title)
            // Your sign-in UI components here.

            // Simulate successful sign-in and request calendar access.
            CalendarAccessView(hasCompletedOnboarding: $hasCompletedOnboarding)
        }
        .padding()
    }
...
struct CreateAccountView: View {
    ...
    var body: some View {
        VStack {
            Text("Create Account")
                .font(.title)
            // Your account creation UI components here.

            // Simulate account creation success and request calendar access.
            CalendarAccessView(hasCompletedOnboarding: $hasCompletedOnboarding)
        }
        .padding()
    }
